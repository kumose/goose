...
unique_ptr<GeoParquetFileMetadata> GeoParquetFileMetadata::TryRead(const goose_parquet::FileMetaData &file_meta_data,
...
void GeoParquetFileMetadata::Write(goose_parquet::FileMetaData &file_meta_data) {
