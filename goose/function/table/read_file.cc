...
#include <goose/function/table/read_file.h>
#include <goose/function/table/direct_file_reader.h>
...
namespace goose {
    namespace {
        ...
        template<class OP>
        bool DirectMultiFileInfo<OP>::ParseCopyOption(ClientContext &context, const string &key,
        ...
        void DirectMultiFileInfo<OP>::BindReader(ClientContext &context, vector<LogicalType> &return_types,
            ...
            bind_data.reader_bind = bind_data.multi_file_reader->BindReader(
                context, return_types, names, *bind_data.file_list, bind_data, *read_bind.options,
        ...
        template<class OP>
        shared_ptr<BaseFileReader> DirectMultiFileInfo<OP>::CreateReader(
            ClientContext &context, const OpenFileInfo &file,
