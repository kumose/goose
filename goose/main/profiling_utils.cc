...
void ProfilingUtils::MetricToJson(goose_yyjson::yyjson_mut_doc *doc, goose_yyjson::yyjson_mut_val *dest, const char *key_ptr,  profiler_metrics_t &metrics, const MetricType &type) {
	switch(type) {
	case MetricType::ALL_OPTIMIZERS:
	case MetricType::ATTACH_LOAD_STORAGE_LATENCY:
	case MetricType::ATTACH_REPLAY_WAL_LATENCY:
