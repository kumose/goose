...
#include <goose/execution/operator/join/outer_join_marker.h>
...
private:
	...
	using scan_t = bool (goose::AsOfPayloadScanner::*)();
	scan_t scan_func;
...
public:
	...
	using resolve_join_t = void (goose::AsOfProbeBuffer::*)(idx_t *);
