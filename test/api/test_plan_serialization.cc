...
static void test_helper(string sql, goose::vector<string> fixtures = goose::vector<string>()) {
	Goose db;
	Connection con(db);
...
static void test_helper_multi_db(string sql, goose::vector<string> fixtures = goose::vector<string>()) {
	Goose db;
	Connection con(db);
