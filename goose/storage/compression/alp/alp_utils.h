...
public:
	...
	static bool MustSkipSamplingFromCurrentVector(idx_t vectors_count, idx_t vectors_sampled_count,
		...
		bool must_select_rowgroup_samples = (vectors_count % AlpConstants::RG_SAMPLES_GOOSE_JUMP) == 0;
		...
		//! We do not take samples of non-complete goose vectors (usually the last one)
