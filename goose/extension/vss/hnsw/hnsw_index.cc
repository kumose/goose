...
#include <goose/optimizer/matcher/expression_type_matcher.h>
#include <goose/optimizer/matcher/function_matcher.h>
#include <goose/optimizer/matcher/set_matcher.h>
...
#include <goose/extension/vss/usearch/goose_usearch.h>
...
namespace goose {
    ...
    // Constructor
    HNSWIndex::HNSWIndex(const string &name, IndexConstraintType index_constraint_type,
    ...
    string HNSWIndex::ToString(IndexLock &state, const bool only_verify) {
