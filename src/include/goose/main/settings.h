...
struct ArrowLosslessConversionSetting {
	...
	static constexpr const char *Description =
	    "Whenever a Goose type does not have a clear native or canonical extension match in Arrow, export the types "
	    "with a goose.type_name extension name.";
	static constexpr const char *InputType = "BOOLEAN";
	static constexpr const char *DefaultValue = "false";
	static constexpr SetScope DefaultScope = SetScope::GLOBAL;
};
...
struct ArrowOutputVersionSetting {
	...
	static constexpr const char *Description =
	    "Whether strings should be produced by Goose in Utf8View format instead of Utf8";
	static constexpr const char *InputType = "VARCHAR";
...
struct CustomUserAgentSetting {
	...
	static constexpr const char *Description = "Metadata from Goose callers";
	static constexpr const char *InputType = "VARCHAR";
	static void SetGlobal(DatabaseInstance *db, DBConfig &config, const Value &parameter);
	static void ResetGlobal(DatabaseInstance *db, DBConfig &config);
	static Value GetSetting(const ClientContext &context);
...
struct DefaultBlockSizeSetting {
	...
	static constexpr const char *Description =
	    "The default block size for new goose database files (new as-in, they do not yet exist).";
	static constexpr const char *InputType = "UBIGINT";
	static void SetGlobal(DatabaseInstance *db, DBConfig &config, const Value &parameter);
	static void ResetGlobal(DatabaseInstance *db, DBConfig &config);
	static Value GetSetting(const ClientContext &context);
...
struct DisableDatabaseInvalidationSetting {
	...
	static constexpr const char *Description =
	    ...
	    "as Goose cannot guarantee correct behavior after a fatal error.";
	static constexpr const char *InputType = "BOOLEAN";
	static void SetGlobal(DatabaseInstance *db, DBConfig &config, const Value &parameter);
	static void ResetGlobal(DatabaseInstance *db, DBConfig &config);
	static bool OnGlobalSet(DatabaseInstance *db, DBConfig &config, const Value &input);
...
struct GooseAPISetting {
	using RETURN_TYPE = string;
	static constexpr const char *Name = "goose_api";
	static constexpr const char *Description = "Goose API surface";
	static constexpr const char *InputType = "VARCHAR";
	static void SetGlobal(DatabaseInstance *db, DBConfig &config, const Value &parameter);
	static void ResetGlobal(DatabaseInstance *db, DBConfig &config);
	static Value GetSetting(const ClientContext &context);
...
struct ExternalThreadsSetting {
	...
	static constexpr const char *Description = "The number of external threads that work on Goose tasks.";
	static constexpr const char *InputType = "UBIGINT";
	static void SetGlobal(DatabaseInstance *db, DBConfig &config, const Value &parameter);
	static void ResetGlobal(DatabaseInstance *db, DBConfig &config);
	static bool OnGlobalSet(DatabaseInstance *db, DBConfig &config, const Value &input);
...
struct ProduceArrowStringViewSetting {
	...
	static constexpr const char *Description =
	    "Whether Arrow strings should be produced by Goose in Utf8View format instead of Utf8";
	static constexpr const char *InputType = "BOOLEAN";
	static constexpr const char *DefaultValue = "false";
	static constexpr SetScope DefaultScope = SetScope::GLOBAL;
};
...
struct StorageCompatibilityVersionSetting {
	...
	static constexpr const char *Description = "Serialize on checkpoint with compatibility for a given goose version";
	static constexpr const char *InputType = "VARCHAR";
	static void SetGlobal(DatabaseInstance *db, DBConfig &config, const Value &parameter);
	static void ResetGlobal(DatabaseInstance *db, DBConfig &config);
	static Value GetSetting(const ClientContext &context);
