...
namespace goose {
    PhysicalLeftDelimJoin::PhysicalLeftDelimJoin(PhysicalPlan &physical_plan, PhysicalPlanGenerator &planner,
        ...
        : PhysicalDelimJoin(physical_plan, PhysicalOperatorType::LEFT_DELIM_JOIN, std::move(types), original_join,
                            distinct,
    ...
    SinkCombineResultType PhysicalLeftDelimJoin::Combine(ExecutionContext &context,
        ...
        OperatorSinkCombineInput distinct_combine_input{
            *distinct.sink_state, *lstate.distinct_state,
