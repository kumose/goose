...
source_files += [
    ...
    for x in [
        ...
        'third_party/thrift/xthrift/protocol/TProtocol.cc',
        'third_party/thrift/xthrift/transport/TTransportException.cc',
        'third_party/thrift/xthrift/transport/TBufferTransports.cc',
