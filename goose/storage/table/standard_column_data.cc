...
void StandardColumnData::GetColumnSegmentInfo(const QueryContext &context, goose::idx_t row_group_index,
                                              vector<goose::idx_t> col_path,
                                              vector<goose::ColumnSegmentInfo> &result) {
