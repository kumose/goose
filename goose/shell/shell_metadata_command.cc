...
#define CTIMEOPT_VAL(opt)  CTIMEOPT_VAL_(opt)
    ...
    MetadataResult DisplayColors(ShellState &state, const vector<string> &args) {
        ...
        ShellHighlight highlighter(state);
        vector<goose::const_reference<HighlightColorInfo> > color_list;
        ...
        vector<vector<string> > color_groups{
            {"red", "maroon", "coral"},
            {"orange"},
    ...
    static const MetadataCommand metadata_commands[] = {
        ...
        {
            "highlight_mode", 2, ToggleHighlightMode, "mixed|dark|light",
            "Toggle the highlight mode to dark or light mode", 0,
            ""
        },
        ...
        },
        {
            ...
            "this\n\t[pager_command]\tSet the pager command to invoke\nNote: Set GOOSE_PAGER or PAGER environment variable "
