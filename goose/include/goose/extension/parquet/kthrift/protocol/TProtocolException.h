...
#ifndef _GOOSE_THRIFT_PROTOCOL_TPROTOCOLEXCEPTION_H_
#define _GOOSE_THRIFT_PROTOCOL_TPROTOCOLEXCEPTION_H_ 1
 ...
 *
 */
class TProtocolException : public goose_apache::thrift::TException {
public:
  /**
  ...
  TProtocolException() : goose_apache::thrift::TException(), type_(UNKNOWN) {}

  TProtocolException(TProtocolExceptionType type) : goose_apache::thrift::TException(), type_(type) {}
...
#endif // #ifndef _GOOSE_THRIFT_PROTOCOL_TPROTOCOLEXCEPTION_H_
