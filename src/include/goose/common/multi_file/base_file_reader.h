...
public:
	...
	GOOSE_API virtual ~BaseFileReader() = default;
...
public:
	GOOSE_API virtual shared_ptr<BaseUnionData> GetUnionData(idx_t file_idx);
	//! Get statistics for a specific column
	GOOSE_API virtual unique_ptr<BaseStatistics> GetStatistics(ClientContext &context, const string &name);
	//! Prepare reader for scanning
	GOOSE_API virtual void PrepareReader(ClientContext &context, GlobalTableFunctionState &);
	...
	GOOSE_API virtual void FinishFile(ClientContext &context, GlobalTableFunctionState &gstate);
	//! Get progress within a given file
	GOOSE_API virtual double GetProgressInFile(ClientContext &context);
...
public:
	GOOSE_API virtual ~BaseFileReaderOptions() = default;
...
public:
	...
	GOOSE_API virtual ~BaseUnionData() = default;
