...
#include <goose/transaction/wal_write_state.h>
#include <goose/transaction/goose_transaction.h>

namespace goose {
    constexpr uint32_t UNDO_ENTRY_HEADER_SIZE = sizeof(UndoFlags) + sizeof(uint32_t);

    UndoBuffer::UndoBuffer(GooseTransaction &transaction_p, ClientContext &context_p)
    ...
    template<class T>
    void UndoBuffer::IterateEntries(UndoBuffer::IteratorState &state, UndoBuffer::IteratorState &end_state,
                                    T &&callback) {
                ...
                case UndoFlags::CATALOG_ENTRY: {
                    ...
                    switch (parent.type) {
                        ...
                        case CatalogType::INDEX_ENTRY: {
                            auto &index = parent.Cast<GooseIndexEntry>();
