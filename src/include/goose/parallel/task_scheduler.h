...
public:
	...
	GOOSE_API static TaskScheduler &GetScheduler(ClientContext &context);
	GOOSE_API static TaskScheduler &GetScheduler(DatabaseInstance &db);
	...
	GOOSE_API int32_t NumberOfThreads();
