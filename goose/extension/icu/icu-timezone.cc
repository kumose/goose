...
#include <goose/extension/icu/icu-casts.h>
...
static goose::unique_ptr<FunctionData> ICUTimeZoneBind(ClientContext &context, TableFunctionBindInput &input,
...
static goose::unique_ptr<GlobalTableFunctionState> ICUTimeZoneInit(ClientContext &context,
...
struct ICULocalTimestampFunc : public ICUDateFunc {
	...
	static goose::unique_ptr<FunctionData> BindNow(ClientContext &context, ScalarFunction &bound_function,
