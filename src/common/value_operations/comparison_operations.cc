...
template <>
inline bool ValuePositionComparator::Definite<goose::Equals>(const Value &lhs, const Value &rhs) {
	return false;
}

template <>
inline bool ValuePositionComparator::Final<goose::Equals>(const Value &lhs, const Value &rhs) {
	return ValueOperations::NotDistinctFrom(lhs, rhs);
}

// NotEquals must check everything that matched
template <>
inline bool ValuePositionComparator::Possible<goose::NotEquals>(const Value &lhs, const Value &rhs) {
	return true;
}

template <>
inline bool ValuePositionComparator::Final<goose::NotEquals>(const Value &lhs, const Value &rhs) {
	return ValueOperations::NotDistinctFrom(lhs, rhs);
}

template <>
bool ValuePositionComparator::Final<goose::GreaterThan>(const Value &lhs, const Value &rhs) {
...
bool ValueOperations::Equals(const Value &left, const Value &right) {
	...
	return TemplatedBooleanOperation<goose::Equals>(left, right);
}
...
bool ValueOperations::GreaterThan(const Value &left, const Value &right) {
	...
	return TemplatedBooleanOperation<goose::GreaterThan>(left, right);
}
