...
template <typename Char> class printf_width_handler {
 ...
 public:
  ...
  unsigned operator()(T value) {
    ...
    if (width > int_max) FMT_THROW(goose::InvalidInputException("number is too big"));
...
OutputIt basic_printf_context<OutputIt, Char>::format() {
  ...
  while (it != end) {
    ...
    // Parse type.
    if (it == end) FMT_THROW(goose::InvalidInputException("invalid format string"));
