...
#include <goose/execution/operator/aggregate/physical_streaming_window.h>
#include <goose/execution/operator/aggregate/physical_window.h>
#include <goose/execution/operator/join/physical_asof_join.h>
#include <goose/execution/operator/join/physical_iejoin.h>
#include <goose/execution/operator/join/physical_nested_loop_join.h>
