...
namespace goose {
    ...
    void CTENode::Serialize(Serializer &serializer) const {
        ...
        serializer.WritePropertyWithDefault<CTEMaterialize>(204, "materialized", materialized,
                                                            CTEMaterialize::CTE_MATERIALIZE_DEFAULT);
    }

    unique_ptr<QueryNode> CTENode::Deserialize(Deserializer &deserializer) {
        auto result = goose::unique_ptr<CTENode>(new CTENode());
    ...
    unique_ptr<QueryNode> RecursiveCTENode::Deserialize(Deserializer &deserializer) {
        auto result = goose::unique_ptr<RecursiveCTENode>(new RecursiveCTENode());
        deserializer.ReadPropertyWithDefault<string>(200, "cte_name", result->ctename);
    ...
    void SelectNode::Serialize(Serializer &serializer) const {
        ...
        serializer.WritePropertyWithDefault<vector<unique_ptr<ParsedExpression> > >(
            203, "group_expressions", groups.group_expressions);
    ...
    unique_ptr<QueryNode> SelectNode::Deserialize(Deserializer &deserializer) {
        auto result = goose::unique_ptr<SelectNode>(new SelectNode());
        deserializer.ReadPropertyWithDefault<vector<unique_ptr<ParsedExpression> > >(
            200, "select_list", result->select_list);
        ...
        deserializer.ReadPropertyWithDefault<vector<unique_ptr<ParsedExpression> > >(
            203, "group_expressions", result->groups.group_expressions);
