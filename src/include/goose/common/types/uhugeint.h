...
public:
	...
	template <class T>
	GOOSE_API static bool TryCast(uhugeint_t input, T &result);
...
template <>
GOOSE_API bool Uhugeint::TryCast(uhugeint_t input, int8_t &result);
template <>
GOOSE_API bool Uhugeint::TryCast(uhugeint_t input, int16_t &result);
template <>
GOOSE_API bool Uhugeint::TryCast(uhugeint_t input, int32_t &result);
template <>
GOOSE_API bool Uhugeint::TryCast(uhugeint_t input, int64_t &result);
template <>
GOOSE_API bool Uhugeint::TryCast(uhugeint_t input, uint8_t &result);
template <>
GOOSE_API bool Uhugeint::TryCast(uhugeint_t input, uint16_t &result);
template <>
GOOSE_API bool Uhugeint::TryCast(uhugeint_t input, uint32_t &result);
template <>
GOOSE_API bool Uhugeint::TryCast(uhugeint_t input, uint64_t &result);
template <>
GOOSE_API bool Uhugeint::TryCast(uhugeint_t input, hugeint_t &result);
template <>
GOOSE_API bool Uhugeint::TryCast(uhugeint_t input, uhugeint_t &result);
template <>
GOOSE_API bool Uhugeint::TryCast(uhugeint_t input, float &result);
template <>
GOOSE_API bool Uhugeint::TryCast(uhugeint_t input, double &result);
