#include <goose/common/types/row/tuple_data_allocator.h>

#include <goose/common/fast_mem.h>
#include <goose/common/radix_partitioning.h>
#include <goose/common/types/row/tuple_data_segment.h>
			...
			if (layout.HasDestructor()) {
				...
				for (auto &aggr_idx : layout.GetAggregateDestructorIndices()) {
					...
					for (idx_t i = 0; i < next; i++) {
						goose::FastMemset(base_row_ptr + i * layout.GetRowWidth() + aggr_offset, '\0',
