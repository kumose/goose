...
namespace goose {
    void CreateInfo::Serialize(Serializer &serializer) const {
        ...
        serializer.WritePropertyWithDefault<InsertionOrderPreservingMap<string> >(
            108, "tags", tags, InsertionOrderPreservingMap<string>());
    ...
    unique_ptr<CreateInfo> CreateInfo::Deserialize(Deserializer &deserializer) {
        ...
        auto dependencies = deserializer.ReadPropertyWithExplicitDefault<LogicalDependencyList>(
    ...
    void CreateIndexInfo::Serialize(Serializer &serializer) const {
        ...
        serializer.WritePropertyWithDefault<vector<unique_ptr<ParsedExpression> > >(
            204, "parsed_expressions", parsed_expressions);
    ...
    unique_ptr<CreateInfo> CreateIndexInfo::Deserialize(Deserializer &deserializer) {
        auto result = goose::unique_ptr<CreateIndexInfo>(new CreateIndexInfo());
        ...
        deserializer.ReadPropertyWithDefault<vector<unique_ptr<ParsedExpression> > >(
            204, "parsed_expressions", result->parsed_expressions);
    ...
    void CreateMacroInfo::Serialize(Serializer &serializer) const {
        ...
        serializer.WritePropertyWithDefault<vector<unique_ptr<MacroFunction> > >(
            202, "extra_functions", GetAllButFirstFunction());
    }
    ...
    unique_ptr<CreateInfo> CreateMacroInfo::Deserialize(Deserializer &deserializer) {
        ...
        auto extra_functions = deserializer.ReadPropertyWithDefault<vector<unique_ptr<MacroFunction> > >(
            202, "extra_functions");
    ...
    unique_ptr<CreateInfo> CreateSchemaInfo::Deserialize(Deserializer &deserializer) {
        auto result = goose::unique_ptr<CreateSchemaInfo>(new CreateSchemaInfo());
        return std::move(result);
    }
    ...
    unique_ptr<CreateInfo> CreateSequenceInfo::Deserialize(Deserializer &deserializer) {
        auto result = goose::unique_ptr<CreateSequenceInfo>(new CreateSequenceInfo());
    ...
    unique_ptr<CreateInfo> CreateTableInfo::Deserialize(Deserializer &deserializer) {
        auto result = goose::unique_ptr<CreateTableInfo>(new CreateTableInfo());
    ...
    unique_ptr<CreateInfo> CreateViewInfo::Deserialize(Deserializer &deserializer) {
        auto result = goose::unique_ptr<CreateViewInfo>(new CreateViewInfo());
