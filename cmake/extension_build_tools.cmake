...
function(goose_cc_extension)
    ...
    add_custom_command(
            ...
            POST_BUILD
            COMMAND
            ${CMAKE_COMMAND} -DABI_TYPE=${ABI_TYPE} -DEXTENSION=$<TARGET_FILE:${KMCMAKE_CC_LIB_NAME}_shared>${EXTENSION_POSTFIX} -DPLATFORM_FILE=${PROJECT_BINARY_DIR}/goose_platform_out -DVERSION_FIELD="${FOOTER_VERSION_VALUE}" -DEXTENSION_VERSION="${KMCMAKE_CC_LIB_EXTENSION_VERSION}" -DNULL_FILE=${NULL_TXT} -P ${META_CMAKE}
    )
