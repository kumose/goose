...
#include <goose/extension/parquet/kthrift/TApplicationException.h>
#include <goose/extension/parquet/kthrift/TBase.h>
...
#include <goose/extension/parquet/windows_compatibility.h>
...
namespace goose_parquet {
    ...
    typedef struct _SizeStatistics__isset {
        _SizeStatistics__isset() : unencoded_byte_array_data_bytes(false), repetition_level_histogram(false),
                                   definition_level_histogram(false) {
        }
    ...
    public:
         ...
         *
         */
        goose::vector<int64_t> repetition_level_histogram;
        /**
         ...
         *
         */
        goose::vector<int64_t> definition_level_histogram;

        _SizeStatistics__isset __isset;

        void __set_unencoded_byte_array_data_bytes(const int64_t val);

        void __set_repetition_level_histogram(const goose::vector<int64_t> &val);

        void __set_definition_level_histogram(const goose::vector<int64_t> &val);
    ...
    public:
         ...
         */
        goose::vector<int32_t> geospatial_types;

        _GeospatialStatistics__isset __isset;

        void __set_bbox(const BoundingBox &val);

        void __set_geospatial_types(const goose::vector<int32_t> &val);
    ...
    typedef struct _Statistics__isset {
        _Statistics__isset() : max(false), min(false), null_count(false), distinct_count(false), max_value(false),
                               min_value(false), is_max_value_exact(false), is_min_value_exact(false) {
        }
    ...
    typedef struct _LogicalType__isset {
        _LogicalType__isset() : STRING(false), MAP(false), LIST(false), ENUM(false), DECIMAL(false), DATE(false),
                                TIME(false), TIMESTAMP(false), INTEGER(false), UNKNOWN(false), JSON(false), BSON(false),
                                UUID(false), FLOAT16(false), VARIANT(false), GEOMETRY(false), GEOGRAPHY(false) {
        }
    ...
    typedef struct _PageHeader__isset {
        _PageHeader__isset() : crc(false), data_page_header(false), index_page_header(false),
                               dictionary_page_header(false), data_page_header_v2(false) {
        }
    ...
    typedef struct _ColumnMetaData__isset {
        _ColumnMetaData__isset() : key_value_metadata(false), index_page_offset(false), dictionary_page_offset(false),
                                   statistics(false), encoding_stats(false), bloom_filter_offset(false),
                                   bloom_filter_length(false), size_statistics(false), geospatial_statistics(false) {
        }
    ...
    public:
         ...
         */
        goose::vector<Encoding::type> encodings;
        /**
         * Path in schema *
         */
        goose::vector<std::string> path_in_schema;
        /**
         * Compression codec *
         *
         ...
         */
        goose::vector<KeyValue> key_value_metadata;
        /**
         ...
         */
        goose::vector<PageEncodingStats> encoding_stats;
        /**
        ...
        void __set_encodings(const goose::vector<Encoding::type> &val);

        void __set_path_in_schema(const goose::vector<std::string> &val);
        ...
        void __set_key_value_metadata(const goose::vector<KeyValue> &val);
        ...
        void __set_encoding_stats(const goose::vector<PageEncodingStats> &val);
    ...
    typedef struct _ColumnChunk__isset {
        _ColumnChunk__isset() : file_path(false), meta_data(false), offset_index_offset(false),
                                offset_index_length(false), column_index_offset(false), column_index_length(false),
                                crypto_metadata(false), encrypted_column_metadata(false) {
        }
    ...
    public:
         ...
         *
         */
        goose::vector<ColumnChunk> columns;
        /**
         ...
         */
        goose::vector<SortingColumn> sorting_columns;
        /**
        ...
        void __set_columns(const goose::vector<ColumnChunk> &val);

        void __set_total_byte_size(const int64_t val);

        void __set_num_rows(const int64_t val);

        void __set_sorting_columns(const goose::vector<SortingColumn> &val);
    ...
    public:
         ...
         */
        goose::vector<PageLocation> page_locations;
        /**
         ...
         */
        goose::vector<int64_t> unencoded_byte_array_data_bytes;

        _OffsetIndex__isset __isset;

        void __set_page_locations(const goose::vector<PageLocation> &val);

        void __set_unencoded_byte_array_data_bytes(const goose::vector<int64_t> &val);
    ...
    typedef struct _ColumnIndex__isset {
        _ColumnIndex__isset() : null_counts(false), repetition_level_histograms(false),
                                definition_level_histograms(false) {
        }
    ...
    public:
         ...
         */
        goose::vector<std::string> min_values;
        goose::vector<std::string> max_values;
        /**
         ...
         * null counts are 0.
         */
        goose::vector<int64_t> null_counts;
        /**
         ...
         *
         */
        goose::vector<int64_t> repetition_level_histograms;
        /**
         * Same as repetition_level_histograms except for definitions levels.
         *
         */
        goose::vector<int64_t> definition_level_histograms;

        _ColumnIndex__isset __isset;

        void __set_null_pages(const goose::vector<bool> &val);

        void __set_min_values(const goose::vector<std::string> &val);

        void __set_max_values(const goose::vector<std::string> &val);

        void __set_boundary_order(const BoundaryOrder::type val);

        void __set_null_counts(const goose::vector<int64_t> &val);

        void __set_repetition_level_histograms(const goose::vector<int64_t> &val);

        void __set_definition_level_histograms(const goose::vector<int64_t> &val);
    ...
    typedef struct _FileMetaData__isset {
        _FileMetaData__isset() : key_value_metadata(false), created_by(false), column_orders(false),
                                 encryption_algorithm(false), footer_signing_key_metadata(false) {
        }
    ...
    public:
         ...
         */
        goose::vector<SchemaElement> schema;
        /**
         ...
         */
        goose::vector<RowGroup> row_groups;
        /**
         * Optional key/value metadata *
         */
        goose::vector<KeyValue> key_value_metadata;
         ...
         */
        goose::vector<ColumnOrder> column_orders;
        /**
        ...
        void __set_schema(const goose::vector<SchemaElement> &val);

        void __set_num_rows(const int64_t val);

        void __set_row_groups(const goose::vector<RowGroup> &val);

        void __set_key_value_metadata(const goose::vector<KeyValue> &val);

        void __set_created_by(const std::string &val);

        void __set_column_orders(const goose::vector<ColumnOrder> &val);
