...
ShellState::ShellState() : seenInterrupt(0), program_name("goose") {
...
void ShellState::Initialize() {
    ...
    default_prompt =
            "{max_length:40}{highlight_element:prompt}{setting:current_database_and_schema}{color:reset} " +
            goose::UserConfig::instance().alter_string + " ";
