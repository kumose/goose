...
//
// Note: The generated code will only work properly if the enum is a top level item in the goose namespace
// If the enum is nested in a class, or in another namespace, the generated code will not compile.
// You should move the enum to the goose namespace, manually write a specialization or add it to the blacklist
//-------------------------------------------------------------------------
...
#include <goose/common/enums/checkpoint_abort.h>
...
#include <goose/common/enums/storage_block_prefetch.h>
...
const StringUtil::EnumStringLiteral *GetDataFileTypeValues() {
	static constexpr StringUtil::EnumStringLiteral values[] {
		...
		{ static_cast<uint32_t>(DataFileType::GOOSE_FILE), "GOOSE_FILE" },
