...
#include <goose/common/enums/http_status_code.h>
...
namespace goose {
    ...
    public:
        ...
        static void ParseHTTPProxyHost(string &proxy_value, string &hostname_out, idx_t &port_out,
                                       idx_t default_port = 80);
    ...
    public:
        static goose::unique_ptr<HTTPResponse>
