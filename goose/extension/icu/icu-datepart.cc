...
struct ICUDatePart : public ICUDateFunc {
	...
	static goose::unique_ptr<FunctionData> BindAdapter(ClientContext &context, ScalarFunction &bound_function,
	...
	static goose::unique_ptr<FunctionData> BindUnaryDatePart(ClientContext &context, ScalarFunction &bound_function,
	                                                          vector<goose::unique_ptr<Expression>> &arguments) {
	...
	static goose::unique_ptr<FunctionData> BindBinaryDatePart(ClientContext &context, ScalarFunction &bound_function,
	                                                           vector<goose::unique_ptr<Expression>> &arguments) {
	...
	static goose::unique_ptr<FunctionData> BindStruct(ClientContext &context, ScalarFunction &bound_function,
	                                                   vector<goose::unique_ptr<Expression>> &arguments) {
	...
	static goose::unique_ptr<FunctionData> DeserializeStructFunction(Deserializer &deserializer,
	...
	static goose::unique_ptr<FunctionData> BindLastDate(ClientContext &context, ScalarFunction &bound_function,
	                                                     vector<goose::unique_ptr<Expression>> &arguments) {
