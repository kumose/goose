...
#define GOOSE_QUOTE_DEFINE(x)      GOOSE_QUOTE_DEFINE_IMPL(x)
    ...
    public:
        ...
        GOOSE_API static vector<string> SplitWithParentheses(const string &str, char delimiter = ',',
                                                             char par_open = '(',
                                                             char par_close = ')');
        ...
        GOOSE_API static void URLEncodeBuffer(const char *input, idx_t input_size, char *output,
        ...
        GOOSE_API static vector<string> TopNLevenshtein(const vector<string> &strings, const string &target,
                                                        idx_t n = 5,
                                                        idx_t threshold = 5);
        ...
        GOOSE_API static vector<string> TopNJaroWinkler(const vector<string> &strings, const string &target,
                                                        idx_t n = 5,
                                                        double threshold = 0.5);
