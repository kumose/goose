...
#include <goose/storage/statistics/geometry_stats.h>
...
public:
	GOOSE_API ~BaseStatistics();
	// disable copy constructors
	BaseStatistics(const BaseStatistics &other) = delete;
	BaseStatistics &operator=(const BaseStatistics &) = delete;
	//! enable move constructors
	GOOSE_API BaseStatistics(BaseStatistics &&other) noexcept;
	GOOSE_API BaseStatistics &operator=(BaseStatistics &&) noexcept;
...
public:
	...
	GOOSE_API StatisticsType GetStatsType() const;
	GOOSE_API static StatisticsType GetStatsType(const LogicalType &type);

	GOOSE_API bool CanHaveNull() const;
	GOOSE_API bool CanHaveNoNull() const;
