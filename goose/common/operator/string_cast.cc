...
template <>
goose::string_t StringCast::Operation(uint8_t input, Vector &vector) {
	return NumericHelper::FormatSigned<uint8_t>(input, vector);
}
template <>
goose::string_t StringCast::Operation(uint16_t input, Vector &vector) {
	return NumericHelper::FormatSigned<uint16_t>(input, vector);
}
template <>
goose::string_t StringCast::Operation(uint32_t input, Vector &vector) {
	return NumericHelper::FormatSigned<uint32_t>(input, vector);
}
template <>
goose::string_t StringCast::Operation(uint64_t input, Vector &vector) {
	return NumericHelper::FormatSigned<uint64_t>(input, vector);
}
template <>
goose::string_t StringCast::Operation(hugeint_t input, Vector &vector) {
	return NumericHelper::FormatSigned<hugeint_t>(input, vector);
}

template <>
string_t StringCast::Operation(float input, Vector &vector) {
	std::string s = goosedb_fmt::format("{}", input);
...
template <>
goose::string_t StringCast::Operation(uhugeint_t input, Vector &vector) {
	return UhugeintToStringCast::Format(input, vector);
}

template <>
goose::string_t StringCast::Operation(date_t input, Vector &vector) {
...
goose::string_t StringAsTime(dtime_t input, Vector &vector) {
	int32_t picos = 0;
	if (HAS_NANOS) {
...
template <>
goose::string_t StringCast::Operation(dtime_t input, Vector &vector) {
	return StringAsTime<false>(input, vector);
}

template <>
goose::string_t StringCast::Operation(dtime_ns_t input, Vector &vector) {
	return StringAsTime<true>(input, vector);
}

template <bool HAS_NANOS>
goose::string_t StringFromTimestamp(timestamp_t input, Vector &vector) {
...
template <>
goose::string_t StringCast::Operation(timestamp_t input, Vector &vector) {
	return StringFromTimestamp<false>(input, vector);
}

template <>
goose::string_t StringCast::Operation(timestamp_ns_t input, Vector &vector) {
	return StringFromTimestamp<true>(input, vector);
}

template <>
goose::string_t StringCast::Operation(goose::string_t input, Vector &result) {
