...
#ifndef _GOOSE_THRIFT_TRANSPORT_TBUFFERTRANSPORTS_H_
#define _GOOSE_THRIFT_TRANSPORT_TBUFFERTRANSPORTS_H_ 1
...
#include <goose/extension/parquet/kthrift/transport/TVirtualTransport.h>
...
public:
  ...
  uint32_t readAll(uint8_t* buf, uint32_t len) {
    ...
    return goose_apache::thrift::transport::readAll(*this, buf, len);
  }
...
#endif // #ifndef _GOOSE_THRIFT_TRANSPORT_TBUFFERTRANSPORTS_H_
