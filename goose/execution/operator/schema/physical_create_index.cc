...
namespace goose {
    PhysicalCreateIndex::PhysicalCreateIndex(PhysicalPlan &physical_plan, LogicalOperator &op,
    ...
    unique_ptr<GlobalSinkState> PhysicalCreateIndex::GetGlobalSinkState(ClientContext &context) const {
        ...
        IndexBuildInitGlobalStateInput global_state_input{
            bind_data.get(), context, table, *info,
    ...
    unique_ptr<LocalSinkState> PhysicalCreateIndex::GetLocalSinkState(ExecutionContext &context) const {
        ...
        IndexBuildInitLocalStateInput local_state_input{
            bind_data.get(), context.client, table,
    ...
    PhysicalCreateIndex::Combine(ExecutionContext &context, OperatorSinkCombineInput &input) const {
        auto &gstate = input.global_state.Cast<CreateIndexGlobalSinkState>();
        auto &lstate = input.local_state.Cast<CreateIndexLocalSinkState>();
