...
namespace goose {
    ...
    unique_ptr<Expression> InClauseRewriter::VisitReplace(BoundOperatorExpression &expr,
        ...
        if (expr.children.size() == 2) {
            ...
            return make_uniq<BoundComparisonExpression>(is_regular_in
        ...
        if (expr.children.size() < 6 || !all_scalar) {
            ...
            auto conjunction = make_uniq<BoundConjunctionExpression>(is_regular_in
