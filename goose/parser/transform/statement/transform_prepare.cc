...
unique_ptr<PrepareStatement> Transformer::TransformPrepare(cantor::PGPrepareStmt &stmt) {
...
unique_ptr<ExecuteStatement> Transformer::TransformExecute(cantor::PGExecuteStmt &stmt) {
...
unique_ptr<DropStatement> Transformer::TransformDeallocate(cantor::PGDeallocateStmt &stmt) {
	if (!stmt.name) {
