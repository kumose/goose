...
#include <goose/utility/t_digest.h>
...
namespace goose {
    namespace {
        ...
        struct ApproxQuantileOperation {
            using SAVE_TYPE = goose_tdigest::Value;
            ...
            static void Operation(STATE &state, const INPUT_TYPE &input, AggregateUnaryInput &unary_input) {
                ...
                if (!state.h) {
                    state.h = new goose_tdigest::TDigest(100);
                }
                state.h->add(val);
                state.pos++;
            }
            ...
            static void Combine(const STATE &source, STATE &target, AggregateInputData &) {
                ...
                D_ASSERT(source.h);
                if (!target.h) {
                    target.h = new goose_tdigest::TDigest(100);
                }
        ...
        AggregateFunction GetApproxQuantileDecimal() {
            ...
            AggregateFunction fun({LogicalTypeId::DECIMAL, LogicalType::FLOAT}, LogicalTypeId::DECIMAL, nullptr,
                                  nullptr,
        ...
        AggregateFunction GetApproxQuantileDecimalList() {
            ...
            AggregateFunction fun({LogicalTypeId::DECIMAL, LogicalType::LIST(LogicalType::FLOAT)},
                                  LogicalType::LIST(LogicalTypeId::DECIMAL), nullptr, nullptr, nullptr, nullptr,
                                  nullptr,
