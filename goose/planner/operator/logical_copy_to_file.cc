...
namespace goose {
    ...
    unique_ptr<LogicalOperator> LogicalCopyToFile::Deserialize(Deserializer &deserializer) {
        ...
        auto copy_info =
                unique_ptr_cast<ParseInfo, CopyInfo>(
                    deserializer.ReadProperty<unique_ptr<ParseInfo> >(209, "copy_info"));
        ...
        auto file_extension =
                deserializer.ReadPropertyWithExplicitDefault<string>(213, "file_extension",
        ...
        auto write_partition_columns = deserializer.ReadPropertyWithExplicitDefault(
            216, "write_partition_columns", true);
