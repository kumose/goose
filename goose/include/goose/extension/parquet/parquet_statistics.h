...
struct ParquetStatisticsUtils {
	...
	static bool BloomFilterExcludes(const TableFilter &filter, const goose_parquet::ColumnMetaData &column_meta_data,
	                                goose_apache::thrift::protocol::TProtocol &file_proto, Allocator &allocator);
