...
unique_ptr<BaseReservoirSampling> BaseReservoirSampling::Deserialize(Deserializer &deserializer) {
	auto result = goose::unique_ptr<BaseReservoirSampling>(new BaseReservoirSampling());
...
shared_ptr<BoundParameterData> BoundParameterData::Deserialize(Deserializer &deserializer) {
	...
	auto result = goose::shared_ptr<BoundParameterData>(new BoundParameterData(value));
...
void ColumnDefinition::Serialize(Serializer &serializer) const {
	...
	serializer.WriteProperty<goose::CompressionType>(104, "compression_type", compression_type);
...
ColumnDefinition ColumnDefinition::Deserialize(Deserializer &deserializer) {
	...
	deserializer.ReadProperty<goose::CompressionType>(104, "compression_type", result.compression_type);
...
unique_ptr<CommonTableExpressionInfo> CommonTableExpressionInfo::Deserialize(Deserializer &deserializer) {
	auto result = goose::unique_ptr<CommonTableExpressionInfo>(new CommonTableExpressionInfo());
...
unique_ptr<BlockingSample> ReservoirSample::Deserialize(Deserializer &deserializer) {
	...
	auto result = goose::unique_ptr<ReservoirSample>(new ReservoirSample(sample_count, std::move(reservoir_chunk)));
...
unique_ptr<BlockingSample> ReservoirSamplePercentage::Deserialize(Deserializer &deserializer) {
	...
	auto result = goose::unique_ptr<ReservoirSamplePercentage>(new ReservoirSamplePercentage(sample_percentage));
...
unique_ptr<SampleOptions> SampleOptions::Deserialize(Deserializer &deserializer) {
	...
	auto result = goose::unique_ptr<SampleOptions>(new SampleOptions(seed));
