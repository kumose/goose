...
#include <goose/execution/operator/persistent/physical_merge_into.h>
...
PhysicalOperator &GooseCatalog::PlanMergeInto(ClientContext &context, PhysicalPlanGenerator &planner,
