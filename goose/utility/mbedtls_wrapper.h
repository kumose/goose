...
namespace goose_mbedtls {
    ...
    public:
        ...
        public:
            GOOSE_API void InitializeEncryption(goose::const_data_ptr_t iv, goose::idx_t iv_len,
                                                goose::const_data_ptr_t key, goose::idx_t key_len,
                                                goose::const_data_ptr_t aad, goose::idx_t aad_len) override;

            GOOSE_API void InitializeDecryption(goose::const_data_ptr_t iv, goose::idx_t iv_len,
                                                goose::const_data_ptr_t key, goose::idx_t key_len,
                                                goose::const_data_ptr_t aad, goose::idx_t aad_len) override;
            ...
            GOOSE_API size_t Finalize(goose::data_ptr_t out, goose::idx_t out_len, goose::data_ptr_t tag,
                                      goose::idx_t tag_len) override;
        ...
        private:
            GOOSE_API void InitializeInternal(goose::const_data_ptr_t iv, goose::idx_t iv_len,
        ...
        public:
            goose::shared_ptr<goose::EncryptionState> CreateEncryptionState(
                goose::EncryptionTypes::CipherType cipher_p, goose::idx_t key_len = 0) const override {
