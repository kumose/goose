...
static void ReadFromIntegers(Goose *db, idx_t thread_idx, atomic<bool> *success) {
	Connection con(*db);
...
static void AppendToIntegers(Goose *db, atomic<bool> *success) {
	Connection con(*db);
...
static void AppendToPK(Goose *db) {
	Connection con(*db);
...
static void MixAppendToPK(Goose *db, atomic<idx_t> *count) {
	Connection con(*db);
...
static void MixUpdatePK(Goose *db, idx_t thread_idx) {
...
static void TransactionalAppendToPK(Goose *db, idx_t thread_idx) {
