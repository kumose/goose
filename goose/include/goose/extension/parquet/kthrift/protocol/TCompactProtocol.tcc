 ...
 * under the License.
 */
#ifndef _GOOSE_THRIFT_PROTOCOL_TCOMPACTPROTOCOL_TCC_
#define _GOOSE_THRIFT_PROTOCOL_TCOMPACTPROTOCOL_TCC_ 1
...
namespace goose_apache { namespace thrift { namespace protocol {
...
#endif // _GOOSE_THRIFT_PROTOCOL_TCOMPACTPROTOCOL_TCC_
