...
#include <goose/extension/icu/icu-current.h>
#include <goose/extension/icu/icu-dateadd.h>
#include <goose/extension/icu/icu-datepart.h>
#include <goose/extension/icu/icu-datesub.h>
#include <goose/extension/icu/icu-datetrunc.h>
#include <goose/extension/icu/icu-list-range.h>
#include <goose/extension/icu/icu-makedate.h>
#include <goose/extension/icu/icu-strptime.h>
#include <goose/extension/icu/icu-table-range.h>
#include <goose/extension/icu/icu-timebucket.h>
#include <goose/extension/icu/icu-timezone.h>
#include <goose/extension/icu/icu_extension.h>
...
#include <goose/extension/icu/icu-helpers.h>
...
static int32_t ICUGetSortKey(xicu::Collator &collator, string_t input, goose::unique_ptr<char[]> &buffer,
	...
	if (string_size > buffer_size) {
		...
		buffer = goose::unique_ptr<char[]>(new char[buffer_size]);
...
static goose::unique_ptr<FunctionData> ICUCollateBind(ClientContext &context, ScalarFunction &bound_function,
...
static goose::unique_ptr<FunctionData> ICUSortKeyBind(ClientContext &context, ScalarFunction &bound_function,
                                                       vector<goose::unique_ptr<Expression>> &arguments) {
...
static goose::unique_ptr<GlobalTableFunctionState> ICUCalendarInit(ClientContext &context,
...
GOOSE_CPP_EXTENSION_ENTRY(icu, loader) { // NOLINT
