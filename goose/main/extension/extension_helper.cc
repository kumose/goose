...
#include <goose/common/serializer/buffered_file_reader.h>
...
#ifndef GOOSE_EXTENSION_CORE_FUNCTIONS_LINKED
#define GOOSE_EXTENSION_CORE_FUNCTIONS_LINKED false
#endif

#ifndef GOOSE_EXTENSION_ICU_LINKED
#define GOOSE_EXTENSION_ICU_LINKED false
#endif

#ifndef GOOSE_EXTENSION_EXCEL_LINKED
#define GOOSE_EXTENSION_EXCEL_LINKED false
#endif

#ifndef GOOSE_EXTENSION_PARQUET_LINKED
#define GOOSE_EXTENSION_PARQUET_LINKED false
#endif

#ifndef GOOSE_EXTENSION_TPCH_LINKED
#define GOOSE_EXTENSION_TPCH_LINKED false
#endif

#ifndef GOOSE_EXTENSION_TPCDS_LINKED
#define GOOSE_EXTENSION_TPCDS_LINKED false
#endif

#ifndef GOOSE_EXTENSION_HTTPFS_LINKED
#define GOOSE_EXTENSION_HTTPFS_LINKED false
#endif

#ifndef GOOSE_EXTENSION_JSON_LINKED
#define GOOSE_EXTENSION_JSON_LINKED false
#endif

#ifndef GOOSE_EXTENSION_JEMALLOC_LINKED
#define GOOSE_EXTENSION_JEMALLOC_LINKED false
#endif

#ifndef GOOSE_EXTENSION_AUTOCOMPLETE_LINKED
#define GOOSE_EXTENSION_AUTOCOMPLETE_LINKED false
#endif

// Load the generated header file containing our list of extension headers
#if defined(GENERATED_EXTENSION_HEADERS) && GENERATED_EXTENSION_HEADERS && !defined(GOOSE_AMALGAMATION)
...
#if GOOSE_EXTENSION_CORE_FUNCTIONS_LINKED
#include "core_functions_extension.h"
#endif

#if GOOSE_EXTENSION_ICU_LINKED
#include "icu_extension.hpp"
#endif

#if GOOSE_EXTENSION_PARQUET_LINKED
#include "parquet_extension.hpp"
#endif

#if GOOSE_EXTENSION_TPCH_LINKED
#include "tpch_extension.hpp"
#endif

#if GOOSE_EXTENSION_TPCDS_LINKED
#include "tpcds_extension.hpp"
#endif

#if GOOSE_EXTENSION_JSON_LINKED
#include "json_extension.hpp"
#endif

#if GOOSE_EXTENSION_JEMALLOC_LINKED
#include "jemalloc_extension.hpp"
#endif

#if GOOSE_EXTENSION_AUTOCOMPLETE_LINKED
...
namespace goose {
    ...
    static const DefaultExtension internal_extensions[] = {
        {"core_functions", "Core function library", GOOSE_EXTENSION_CORE_FUNCTIONS_LINKED},
        {"icu", "Adds support for time zones and collations using the ICU library", GOOSE_EXTENSION_ICU_LINKED},
        {"excel", "Adds support for Excel-like format strings", GOOSE_EXTENSION_EXCEL_LINKED},
        {"parquet", "Adds support for reading and writing parquet files", GOOSE_EXTENSION_PARQUET_LINKED},
        {"tpch", "Adds TPC-H data generation and query support", GOOSE_EXTENSION_TPCH_LINKED},
        {"tpcds", "Adds TPC-DS data generation and query support", GOOSE_EXTENSION_TPCDS_LINKED},
        {
            "httpfs", "Adds support for reading and writing files over a HTTP(S) connection",
            GOOSE_EXTENSION_HTTPFS_LINKED
        },
        {"json", "Adds support for JSON operations", GOOSE_EXTENSION_JSON_LINKED},
        {"autocomplete", "Adds support for autocomplete in the shell", GOOSE_EXTENSION_AUTOCOMPLETE_LINKED},
        ...
        {"azure", "Adds a filesystem abstraction for Azure blob storage to Goose", false},
        ...
        {"ui", "Adds local UI for Goose", false},
...
#ifdef GOOSE_DISABLE_EXTENSION_LOAD
        return false;
#endif
    ...
    vector<ExtensionUpdateResult> ExtensionHelper::UpdateExtensions(ClientContext &context) {
        ...
        fs.ListFiles(ext_directory, [&](const string &path, bool is_directory) {
            if (!StringUtil::EndsWith(path, ".goose_extension")) {
                return;
            }
            ...
            result.push_back(UpdateExtensionInternal(context, db, fs, fs.JoinPath(ext_directory, path),
                                                     extension_name));
        });
#endif
    ...
    ExtensionUpdateResult ExtensionHelper::UpdateExtension(ClientContext &context, const string &extension_name) {
        ...
        auto full_extension_path = fs.JoinPath(ext_directory, extension_name + ".goose_extension");
    ...
    void ExtensionHelper::AutoLoadExtension(DatabaseInstance &db, const string &extension_name) {
        ...
        try {
            ...
            GOOSE_LOG_INFO(db, "Loaded extension '%s'", extension_name);
        } catch (std::exception &e) {
            ErrorData error(e);
