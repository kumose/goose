...
#include <goose/extension/parquet/decoder/byte_stream_split_decoder.h>
#include <goose/extension/parquet/decoder/delta_binary_packed_decoder.h>
#include <goose/extension/parquet/decoder/dictionary_decoder.h>
#include <goose/extension/parquet/decoder/rle_decoder.h>
#include <goose/extension/parquet/decoder/delta_length_byte_array_decoder.h>
#include <goose/extension/parquet/decoder/delta_byte_array_decoder.h>
#include <goose/extension/parquet/parquet_column_schema.h>
...
#include <goose/common/types/vector_cache.h>
#include <goose/common/encryption_functions.h>

namespace goose {
class ParquetReader;
struct TableFilterState;

using goose_apache::thrift::protocol::TProtocol;
...
public:
	...
	void InitializeCryptoMetadata(const goose_parquet::EncryptionAlgorithm &encryption_algorithm,
...
protected:
	...
	void DirectSelect(uint64_t num_values, data_ptr_t define_out, data_ptr_t repeat_out, Vector &result,
	                  const SelectionVector &sel, idx_t approved_tuple_count);
	void ReadEncrypted(goose_apache::thrift::TBase &object);
