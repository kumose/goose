...
#ifndef GOOSE_BLOCK_HEADER_STORAGE_SIZE
#define GOOSE_BLOCK_HEADER_STORAGE_SIZE     DEFAULT_BLOCK_HEADER_STORAGE_SIZE
...
struct Storage {
	...
	//! The maximum block allocation size. This is the maximum size currently supported by goose.
...
string GetGooseVersions(const idx_t version_number);
