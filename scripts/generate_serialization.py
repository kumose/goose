...
def get_file_list():
    if args.source is None:
        targets = [
            {'source': 'goose/storage/serialization', 'target': 'goose/storage/serialization'},
...
version_map_path = scripts_dir + '/../goose/storage/version_map.json'
...
HEADER = '''// Copyright (C) 2026 Kumo inc. and its affiliates. All Rights Reserved.
//
