...
#include <goose/main/relation/read_csv_relation.h>
...
#include <goose/main/relation/view_relation.h>
...
Connection::Connection(Goose &database) : Connection(*database.instance) {
}
