...
#include <goose/function/table/arrow/enum/arrow_type_info_type.h>
#include <goose/function/table/arrow/enum/arrow_datetime_type.h>
#include <goose/function/table/arrow/enum/arrow_variable_size_type.h>
