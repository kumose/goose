...
namespace goose {
    ...
    PEGTransformerFactory::TransformNestedColumnName(PEGTransformer &transformer,
                                                     optional_ptr<ParseResult> parse_result) {
        auto &list_pr = parse_result->Cast<ListParseResult>();
    ...
    PEGTransformerFactory::TransformArrayBoundedListExpression(PEGTransformer &transformer,
        ...
        auto list_expr = transformer.Transform<vector<unique_ptr<ParsedExpression> > >(
    ...
    PEGTransformerFactory::TransformLambdaArrowExpression(PEGTransformer &transformer,
        ...
        for (auto lambda_expr: inner_lambda_list.children) {
            ...
            auto right_expr = transformer.Transform<unique_ptr<ParsedExpression> >(
                inner_list_pr.Child<ListParseResult>(1));
    ...
    PEGTransformerFactory::TransformLogicalOrExpression(PEGTransformer &transformer,
        ...
        for (auto &or_expr: or_expr_repeat.children) {
            ...
            auto right_expr = transformer.Transform<unique_ptr<ParsedExpression> >(
                inner_list_pr.Child<ListParseResult>(1));
            expr = make_uniq<ConjunctionExpression>(ExpressionType::CONJUNCTION_OR, std::move(expr),
                                                    std::move(right_expr));
        }
        return expr;
    }
    ...
    PEGTransformerFactory::TransformLogicalAndExpression(PEGTransformer &transformer,
        ...
        for (auto &and_expr: and_expr_repeat.children) {
            ...
            auto right_expr = transformer.Transform<unique_ptr<ParsedExpression> >(
                inner_list_pr.Child<ListParseResult>(1));
            expr =
                    make_uniq<ConjunctionExpression>(ExpressionType::CONJUNCTION_AND, std::move(expr),
                                                     std::move(right_expr));
        }
        return expr;
    }
    ...
    unique_ptr<ParsedExpression> PEGTransformerFactory::TransformIsLiteral(PEGTransformer &transformer,
        ...
        if (literal_value.IsNull()) {
            auto expr_type = not_expr.HasResult()
    ...
    unique_ptr<ParsedExpression> PEGTransformerFactory::TransformLikeClause(PEGTransformer &transformer,
        ...
        like_children.
                push_back(transformer.Transform<unique_ptr<ParsedExpression> >(list_pr.Child<ListParseResult>(1)));
    ...
    unique_ptr<ParsedExpression> PEGTransformerFactory::TransformConstantLiteral(PEGTransformer &transformer,
        ...
        return make_uniq<ConstantExpression>(
            transformer.TransformEnum<Value>(list_pr.Child<ChoiceParseResult>(0).result));
    }
    ...
    unique_ptr<ParsedExpression> PEGTransformerFactory::TransformSliceExpression(PEGTransformer &transformer,
        optional_ptr<ParseResult> parse_result) {
        auto &list_pr = parse_result->Cast<ListParseResult>();
        auto slice_bound = transformer.Transform<vector<unique_ptr<ParsedExpression> > >(
            list_pr.Child<ListParseResult>(1));
    ...
    PEGTransformerFactory::TransformSliceBound(PEGTransformer &transformer, optional_ptr<ParseResult> parse_result) {
        ...
        if (step_slice_opt.HasResult()) {
            slice_bounds.
                    push_back(transformer.Transform<unique_ptr<ParsedExpression> >(step_slice_opt.optional_result));
        }
        return slice_bounds;
    }
    ...
    PEGTransformerFactory::TransformWindowFrameContents(PEGTransformer &transformer,
        ...
        auto result =
                make_uniq<WindowExpression>(ExpressionType::WINDOW_AGGREGATE, INVALID_CATALOG, INVALID_SCHEMA,
                                            string());
        auto partition_opt = list_pr.Child<OptionalParseResult>(0);
        if (partition_opt.HasResult()) {
            result->partitions = transformer.Transform<vector<unique_ptr<ParsedExpression> > >(
                partition_opt.optional_result);
        }
    ...
    unique_ptr<ParsedExpression> PEGTransformerFactory::TransformColumnsExpression(PEGTransformer &transformer,
        ...
        auto result = make_uniq<StarExpression>();
        auto expr =
                transformer.Transform<unique_ptr<ParsedExpression> >(
                    ExtractResultFromParens(list_pr.Child<ListParseResult>(2)));
    ...
    unique_ptr<ParsedExpression> PEGTransformerFactory::TransformTrimExpression(PEGTransformer &transformer,
        ...
        if (trim_source_opt.HasResult()) {
            auto trim_source_expr = transformer.Transform<unique_ptr<ParsedExpression> >(
                trim_source_opt.optional_result);
            if (trim_source_expr) {
                trim_expressions.push_back(std::move(trim_source_expr));
            }
        }
        return make_uniq<FunctionExpression>(INVALID_CATALOG, DEFAULT_SCHEMA, function_name,
    ...
    PEGTransformerFactory::TransformPositionExpression(PEGTransformer &transformer,
        ...
        results.push_back(
            transformer.Transform<unique_ptr<ParsedExpression> >(position_values.Child<ListParseResult>(2)));
        results.push_back(
            transformer.Transform<unique_ptr<ParsedExpression> >(position_values.Child<ListParseResult>(0)));
