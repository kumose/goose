#include <goose/main/relation/table_relation.h>
...
#include <goose/main/relation/delete_relation.h>
#include <goose/main/relation/value_relation.h>
#include <goose/main/relation/update_relation.h>
...
namespace goose {
    ...
    void TableRelation::Update(vector<string> names, vector<unique_ptr<ParsedExpression> > &&update,
        ...
        auto update_relation =
                make_shared_ptr<UpdateRelation>(context, std::move(condition), description->database,
                                                description->schema,
    ...
    void TableRelation::Insert(vector<vector<unique_ptr<ParsedExpression> > > &&expressions) {
        vector<string> column_names;
        auto rel = make_shared_ptr<ValueRelation>(context->GetContext(), std::move(expressions),
