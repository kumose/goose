...
namespace goose {
    ...
    class unique_ptr : public goose_base_std::unique_ptr<DATA_TYPE, DELETER> { // NOLINT: naming
    public:
        using original = goose_base_std::unique_ptr<DATA_TYPE, DELETER>;
    ...
    private:
        static inline void AssertNotNull(const bool null) {
            ...
            if (TURBO_UNLIKELY(null)) {
                throw goose::InternalException("Attempted to dereference unique_ptr that is NULL!");
            }
#endif
        }
    ...
    class unique_ptr<DATA_TYPE[], DELETER, true> : public goose_base_std::unique_ptr<DATA_TYPE[], DELETER> {
    public:
        using original = goose_base_std::unique_ptr<DATA_TYPE[], DELETER>;
    ...
    class unique_ptr<DATA_TYPE[], DELETER, SAFE> : public goose_base_std::unique_ptr<DATA_TYPE[], DELETER> {
    public:
        using original = goose_base_std::unique_ptr<DATA_TYPE[], DELETER>;
        using original::original;
