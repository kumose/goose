...
#ifndef _GOOSE_THRIFT_TRANSPORT_TTRANSPORTEXCEPTION_H_
#define _GOOSE_THRIFT_TRANSPORT_TTRANSPORTEXCEPTION_H_ 1

#include <string>
#include <goose/extension/parquet/kthrift/Thrift.h>
 ...
 *
 */
class TTransportException : public goose_apache::thrift::TException {
public:
  /**
  ...
  TTransportException() : goose_apache::thrift::TException(), type_(UNKNOWN) {}

  TTransportException(TTransportExceptionType type) : goose_apache::thrift::TException(), type_(type) {}

  TTransportException(const std::string& message)
    : goose_apache::thrift::TException(message), type_(UNKNOWN) {}

  TTransportException(TTransportExceptionType type, const std::string& message)
    : goose_apache::thrift::TException(message), type_(type) {}
...
} // goose_apache::thrift::transport

#endif // #ifndef _GOOSE_THRIFT_TRANSPORT_TTRANSPORTEXCEPTION_H_
