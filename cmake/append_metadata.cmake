...
# Usage: cmake -DEXTENSION=path/to/extension.goose_extension -DPLATFORM_FILE=README.md -DGOOSE_VERSION=tag1 -DEXTENSION_VERSION=tag2 -P cmake/append_metadata.cmake
# Currently hardcoded to host up to 8 fields
# Example: ./scripts/append_metadata.sh file.goose_extension git_hash_goose_file git_hash_extension_file platfrom_file
...
set(PLATFORM_FILE "" CACHE PATH "Metadata field: path of file containing goose_platform")
set(VERSION_FIELD "" CACHE STRING "Metadata field: path of file containing goose_version")
...
string(APPEND CUSTOM_SECTION "goose_signature")
