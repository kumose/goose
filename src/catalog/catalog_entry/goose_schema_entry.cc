...
optional_ptr<CatalogEntry> GooseSchemaEntry::CreateTable(CatalogTransaction transaction, BoundCreateTableInfo &info) {
...
optional_ptr<CatalogEntry> GooseSchemaEntry::CreateFunction(CatalogTransaction transaction, CreateFunctionInfo &info) {
...
optional_ptr<CatalogEntry> GooseSchemaEntry::AddEntry(CatalogTransaction transaction, unique_ptr<StandardEntry> entry,
                                                     OnCreateConflict on_conflict) {
...
optional_ptr<CatalogEntry> GooseSchemaEntry::CreateSequence(CatalogTransaction transaction, CreateSequenceInfo &info) {
...
optional_ptr<CatalogEntry> GooseSchemaEntry::CreateCollation(CatalogTransaction transaction, CreateCollationInfo &info) {
