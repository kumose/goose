...
bool CardinalityEstimator::SingleColumnFilter(goose::FilterInfo &filter_info) {
...
// https://blobs.gsst.org/papers/tom-ebergen-msc-thesis-join-order-optimization-with-almost-no-statistics.pdf TL;DR
