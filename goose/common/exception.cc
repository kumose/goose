...
string OutOfMemoryException::ExtendOutOfMemoryError(const string &msg) {
	string link = "https://pub.kumose.cc/goose/docs/guides/performance/how_to_tune_workloads";
