...
// python3 scripts/generate_extensions_function.py --extensions icu --shell build/debug/goose --extension_repository
...
static constexpr ExtensionFunctionEntry EXTENSION_FUNCTIONS[] = {
    ...
    {"goose_proj_compiled_version", "spatial", CatalogType::SCALAR_FUNCTION_ENTRY},
    {"goose_proj_version", "spatial", CatalogType::SCALAR_FUNCTION_ENTRY},
...
// TODO: automate by passing though to script via goose
