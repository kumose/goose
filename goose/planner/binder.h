...
#include <goose/common/enums/copy_option_mode.h>
#include <xre2/re2.h>
...
public:
	GOOSE_API static shared_ptr<Binder> CreateBinder(ClientContext &context, optional_ptr<Binder> parent = nullptr,
...
public:
	GOOSE_API BoundStatement Bind(SQLStatement &statement);
	GOOSE_API BoundStatement Bind(QueryNode &node);
