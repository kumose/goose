...
public:
	...
	static void WaggleOptimizeFunction(OptimizerExtensionInput &input, goose::unique_ptr<LogicalOperator> &plan) {
...
GOOSE_CPP_EXTENSION_ENTRY(loadable_extension_optimizer_demo, loader) {
