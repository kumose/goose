...
#include <goose/common/enums/memory_tag.h>
...
public:
	GOOSE_API static BufferManager &GetBufferManager(DatabaseInstance &db);
	GOOSE_API static const BufferManager &GetBufferManager(const DatabaseInstance &db);
	GOOSE_API static BufferManager &GetBufferManager(ClientContext &context);
	GOOSE_API static const BufferManager &GetBufferManager(const ClientContext &context);
	GOOSE_API static BufferManager &GetBufferManager(AttachedDatabase &db);
	GOOSE_API static idx_t GetAllocSize(const idx_t alloc_size);
...
public:
	...
	virtual GOOSE_API Allocator &GetBufferAllocator();
	//! Reserve memory.
	virtual GOOSE_API void ReserveMemory(idx_t size);
	//! Free reserved memory.
	virtual GOOSE_API void FreeReservedMemory(idx_t size);
