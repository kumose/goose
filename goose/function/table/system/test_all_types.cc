    ...
    vector<TestType> TestAllTypesFun::GetTestTypes(const bool use_large_enum, const bool use_large_bignum) {
        ...
        auto int_list =
                Value::LIST(LogicalType::INTEGER, {
                                Value::INTEGER(42), Value::INTEGER(999), Value(LogicalType::INTEGER),
        ...
        auto double_list = Value::LIST(LogicalType::DOUBLE, {
                                           Value::DOUBLE(42), Value::DOUBLE(NAN),
        ...
        auto date_list = Value::LIST(LogicalType::DATE, {
                                         Value::DATE(date_t()), Value::DATE(date_t::infinity()),
        ...
        auto timestamptz_list =
                Value::LIST(LogicalType::TIMESTAMP_TZ,
                            {
                                Value::TIMESTAMPTZ(timestamp_tz_t()),
                                Value::TIMESTAMPTZ(timestamp_tz_t(timestamp_t::infinity())),
                                Value::TIMESTAMPTZ(timestamp_tz_t(timestamp_t::ninfinity())),
                                Value(LogicalType::TIMESTAMP_TZ),
                                Value::TIMESTAMPTZ(
                                    timestamp_tz_t(Timestamp::FromString("2022-05-12 16:23:45-07", true)))
                            });
        ...
        result.emplace_back(fixed_int_array_type, "fixed_int_array", fixed_int_min_array_value,
        ...
        auto fixed_nested_varchar_min_array_value =
                Value::ARRAY(fixed_varchar_array_type,
                             {
                                 fixed_varchar_min_array_value, Value(fixed_varchar_array_type),
                                 fixed_varchar_min_array_value
                             });
        auto fixed_nested_varchar_max_array_value =
                Value::ARRAY(fixed_varchar_array_type,
                             {
                                 fixed_varchar_max_array_value, fixed_varchar_min_array_value,
                                 fixed_varchar_max_array_value
                             });
        ...
        auto fixed_array_of_list_of_int_min_value = Value::ARRAY(int_list_type, {
                                                                     empty_int_list, int_list, empty_int_list
                                                                 });
