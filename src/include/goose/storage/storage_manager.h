...
#include <goose/storage/checkpoint/checkpoint_options.h>
#include <goose/storage/storage_options.h>
...
public:
	...
	//! either set, or invalid. If invalid, then Goose defaults to the default_block_alloc_size (DBConfig),
