...
inline goosedb_fmt::internal::null<> strerror_r(int, char*, ...) { return {}; }
inline goosedb_fmt::internal::null<> strerror_s(char*, std::size_t, ...) { return {}; }
...
FMT_FUNC void internal::error_handler::on_error(std::string message) {
  FMT_THROW(goose::InvalidInputException(message));
}
