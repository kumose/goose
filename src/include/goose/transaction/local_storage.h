...
public:
	...
	void AppendToIndexes(GooseTransaction &transaction, TableAppendState &append_state);
	void AppendToTable(GooseTransaction &transaction, TableAppendState &append_state);
	ErrorData AppendToIndexes(GooseTransaction &transaction, RowGroupCollection &source, TableIndexList &index_list,
...
public:
	explicit LocalStorage(ClientContext &context, GooseTransaction &transaction);

	static LocalStorage &Get(GooseTransaction &transaction);
