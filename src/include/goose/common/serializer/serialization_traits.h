...
template <typename T>
struct is_vector<typename goose::vector<T>> : std::true_type {
...
template <typename T>
struct is_unsafe_vector<typename goose::unsafe_vector<T>> : std::true_type {
	typedef T ELEMENT_TYPE;
};
...
struct is_unordered_map<typename goose::unordered_map<Args...>> : std::true_type {
...
template <typename... Args>
struct is_map<typename goose::map<Args...>> : std::true_type {
	typedef typename std::tuple_element<0, std::tuple<Args...>>::type KEY_TYPE;
	typedef typename std::tuple_element<1, std::tuple<Args...>>::type VALUE_TYPE;
	typedef typename std::tuple_element<2, std::tuple<Args...>>::type HASH_TYPE;
	typedef typename std::tuple_element<3, std::tuple<Args...>>::type EQUAL_TYPE;
...
template <typename... Args>
struct is_insertion_preserving_map<typename goose::InsertionOrderPreservingMap<Args...>> : std::true_type {
...
template <typename... Args>
struct is_unordered_set<goose::unordered_set<Args...>> : std::true_type {
...
template <typename... Args>
struct is_set<goose::set<Args...>> : std::true_type {
	typedef typename std::tuple_element<0, std::tuple<Args...>>::type ELEMENT_TYPE;
	typedef typename std::tuple_element<1, std::tuple<Args...>>::type HASH_TYPE;
	typedef typename std::tuple_element<2, std::tuple<Args...>>::type EQUAL_TYPE;
};
