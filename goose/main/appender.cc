...
void goose::BaseAppender::Append(DataChunk &target, const Value &value, idx_t col, idx_t row) {
...
void goose::Appender::AppendDefault(DataChunk &chunk, idx_t col, idx_t row) {
