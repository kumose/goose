...
#include <goose/extension/parquet/kthrift/transport/TBufferTransports.h>
...
class ThriftFileTransport : public goose_apache::thrift::transport::TVirtualTransport<ThriftFileTransport> {
public:
