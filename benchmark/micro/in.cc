...
#define IN_QUERY_BODY(INCOUNT, NOT_IN)                                                                                 \
	...
	virtual void Load(GooseBenchmarkState *state) {                                                                   \
