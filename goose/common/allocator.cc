...
#ifndef USE_JEMALLOC
#if defined(GOOSE_EXTENSION_JEMALLOC_LINKED) && GOOSE_EXTENSION_JEMALLOC_LINKED && !defined(WIN32) &&                \
...
AllocatorDebugInfo::~AllocatorDebugInfo() {
	...
	//! If this assertion triggers, enable GOOSE_DEBUG_ALLOCATION for more information about the allocations
