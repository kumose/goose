...
#include <goose/execution/index/index_pointer.h>
...
#include <goose/extension/vss/usearch/index_dense.h>
...
namespace goose {
    ...
    public:
        ...
        string ToString(IndexLock &state, const bool only_verify) override;
