...
#include <goose/extension/json/json_deserializer.h>
#include <goose/extension/json/json_functions.h>
#include <goose/extension/json/json_serializer.h>
...
namespace goose {
        ...
        UnaryExecutor::Execute<string_t, string_t>(inputs, result, args.size(), [&](string_t input) {
            ...
            try {
                ...
                for (auto &statement: parser.statements) {
                    ...
                    auto json =
                            JsonSerializer::Serialize(select, doc, info.skip_if_null, info.skip_if_empty,
                                                      info.skip_if_default);
                ...
                auto data = yyjson_mut_val_write_opts(result_obj,
                                                      info.format
                                                          ? JSONCommon::WRITE_PRETTY_FLAG
                                                          : JSONCommon::WRITE_FLAG,
    ...
    ScalarFunctionSet JSONFunctions::GetSerializeSqlFunction() {
        ...
        set.AddFunction(ScalarFunction(
            {LogicalType::VARCHAR, LogicalType::BOOLEAN, LogicalType::BOOLEAN, LogicalType::BOOLEAN},
            LogicalType::JSON(),
