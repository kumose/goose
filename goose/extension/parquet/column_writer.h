...
public:
	...
	virtual void FinalizeSchema(vector<goose_parquet::SchemaElement> &schemas) = 0;
	...
	virtual unique_ptr<ColumnWriterState> InitializeWriteState(goose_parquet::RowGroup &row_group) = 0;
