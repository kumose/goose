...
struct FunctionLocalState {
	GOOSE_API virtual ~FunctionLocalState();
...
struct ScalarFunctionInfo {
	GOOSE_API virtual ~ScalarFunctionInfo();
...
public:
	GOOSE_API ScalarFunction(string name, vector<LogicalType> arguments, LogicalType return_type,
	...
	GOOSE_API ScalarFunction(vector<LogicalType> arguments, LogicalType return_type, scalar_function_t function,
...
public:
	GOOSE_API bool operator==(const ScalarFunction &rhs) const;
	GOOSE_API bool operator!=(const ScalarFunction &rhs) const;

	GOOSE_API bool Equal(const ScalarFunction &rhs) const;

public:
	GOOSE_API static void NopFunction(DataChunk &input, ExpressionState &state, Vector &result);
