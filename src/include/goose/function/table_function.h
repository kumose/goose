...
#include <goose/storage/table/row_group_reorderer.h>
...
struct TableFunctionInfo {
	GOOSE_API virtual ~TableFunctionInfo();
...
public:
	GOOSE_API virtual ~GlobalTableFunctionState();
...
struct LocalTableFunctionState {
	GOOSE_API virtual ~LocalTableFunctionState();
...
public:
	...
	GOOSE_API bool Equal(const TableFunction &rhs) const;
	GOOSE_API bool operator==(const TableFunction &rhs) const;
	GOOSE_API bool operator!=(const TableFunction &rhs) const;
};
