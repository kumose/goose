...
namespace goose {
    ...
    unique_ptr<TableRef> TableRef::Deserialize(Deserializer &deserializer) {
        ...
        auto query_location = deserializer.ReadPropertyWithExplicitDefault<optional_idx>(
            103, "query_location", optional_idx());
    ...
    unique_ptr<AtClause> AtClause::Deserialize(Deserializer &deserializer) {
        ...
        auto result = goose::unique_ptr<AtClause>(new AtClause(std::move(unit), std::move(expr)));
        return result;
    }
    ...
    unique_ptr<TableRef> BaseTableRef::Deserialize(Deserializer &deserializer) {
        auto result = goose::unique_ptr<BaseTableRef>(new BaseTableRef());
    ...
    unique_ptr<TableRef> ColumnDataRef::Deserialize(Deserializer &deserializer) {
        ...
        auto collection = deserializer.ReadPropertyWithDefault<optionally_owned_ptr<ColumnDataCollection> >(
            202, "collection");
    ...
    unique_ptr<TableRef> ExpressionListRef::Deserialize(Deserializer &deserializer) {
        auto result = goose::unique_ptr<ExpressionListRef>(new ExpressionListRef());
    ...
    void JoinRef::Serialize(Serializer &serializer) const {
        ...
        serializer.WritePropertyWithDefault<vector<unique_ptr<ParsedExpression> > >(
            207, "duplicate_eliminated_columns", duplicate_eliminated_columns);
    ...
    unique_ptr<TableRef> JoinRef::Deserialize(Deserializer &deserializer) {
        auto result = goose::unique_ptr<JoinRef>(new JoinRef());
    ...
    unique_ptr<TableRef> PivotRef::Deserialize(Deserializer &deserializer) {
        auto result = goose::unique_ptr<PivotRef>(new PivotRef());
        deserializer.ReadPropertyWithDefault<unique_ptr<TableRef> >(200, "source", result->source);
        deserializer.ReadPropertyWithDefault<vector<unique_ptr<ParsedExpression> > >(
            201, "aggregates", result->aggregates);
    ...
    unique_ptr<TableRef> ShowRef::Deserialize(Deserializer &deserializer) {
        auto result = goose::unique_ptr<ShowRef>(new ShowRef());
    ...
    unique_ptr<TableRef> TableFunctionRef::Deserialize(Deserializer &deserializer) {
        auto result = goose::unique_ptr<TableFunctionRef>(new TableFunctionRef());
