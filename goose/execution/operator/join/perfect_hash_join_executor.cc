    ...
    bool PerfectHashJoinExecutor::TemplatedFillSelectionVectorBuild(Vector &source, SelectionVector &sel_vec,
        ...
        for (idx_t i = 0, sel_idx = 0; i < count; ++i) {
            ...
            if (min_value <= input_value && input_value <= max_value) {
                auto idx = UnsafeNumericCast<idx_t>(input_value - min_value);
        ...
        switch (source.GetType().InternalType()) {
            ...
            case PhysicalType::INT16:
                TemplatedFillSelectionVectorProbe<
                    int16_t>(source, build_sel_vec, probe_sel_vec, count, probe_sel_count);
                break;
            case PhysicalType::INT32:
                TemplatedFillSelectionVectorProbe<
                    int32_t>(source, build_sel_vec, probe_sel_vec, count, probe_sel_count);
                break;
            case PhysicalType::INT64:
                TemplatedFillSelectionVectorProbe<
                    int64_t>(source, build_sel_vec, probe_sel_vec, count, probe_sel_count);
                break;
            case PhysicalType::INT128:
                TemplatedFillSelectionVectorProbe<hugeint_t>(source, build_sel_vec, probe_sel_vec, count,
                                                             probe_sel_count);
                break;
            case PhysicalType::UINT8:
                TemplatedFillSelectionVectorProbe<
                    uint8_t>(source, build_sel_vec, probe_sel_vec, count, probe_sel_count);
                break;
            case PhysicalType::UINT16:
            ...
            case PhysicalType::UINT64:
                ...
                break;
            case PhysicalType::UINT128:
                TemplatedFillSelectionVectorProbe<uhugeint_t>(source, build_sel_vec, probe_sel_vec, count,
                                                              probe_sel_count);
                break;
            default:
