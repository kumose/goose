...
#define FMT_ASSERT(condition, message)
        ...
        using int128_t = goose::hugeint_t;
        using uint128_t = goose::uhugeint_t;
...
#  define FMT_USE_INT128 0
    ...
    namespace internal {
        ...
        using goosedb_fmt::v6::to_string_view;
  ...
  struct type_constant<Type, Char> : std::integral_constant<type, constant> {}
    ...
    public:
        ...
        int max_size() const {
            ...
            return static_cast<int>(is_packed()
                                        ? max_packed
