...
namespace goose {
    ...
    static goose::unique_ptr<FunctionData> TPCHQueryBind(ClientContext &context, TableFunctionBindInput &input,
                                                         vector<LogicalType> &return_types, vector<string> &names) {
    ...
    static goose::unique_ptr<FunctionData> TPCHQueryAnswerBind(ClientContext &context, TableFunctionBindInput &input,
    ...
    static void LoadInternal(ExtensionLoader &loader) {
        ...
        TableFunction tpch_query_answer_func("tpch_answers", {}, TPCHQueryAnswerFunction, TPCHQueryAnswerBind,
                                             TPCHInit);
...
extern "C" {
GOOSE_CPP_EXTENSION_ENTRY(tpch, loader) {
