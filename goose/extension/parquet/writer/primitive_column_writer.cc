...
namespace goose {
    ...
    void PrimitiveColumnWriter::RegisterToRowGroup(goose_parquet::RowGroup &row_group) {
        goose_parquet::ColumnChunk column_chunk;
    ...
    goose_parquet::Encoding::type PrimitiveColumnWriter::GetEncoding(PrimitiveColumnWriterState &state) {
    ...
    void PrimitiveColumnWriter::NextPage(PrimitiveColumnWriterState &state) {
        ...
        WriteLevels(allocator, temp_writer, state.repetition_levels, MaxRepeat(), page_info.offset,
                    page_info.row_count);
    ...
    void PrimitiveColumnWriter::FinalizeSchema(vector<goose_parquet::SchemaElement> &schemas) {
        ...
        goose_parquet::SchemaElement schema_element;
        schema_element.type = ParquetWriter::GooseTypeToParquetType(type);
