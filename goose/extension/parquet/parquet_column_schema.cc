...
ParquetColumnSchema ParquetColumnSchema::FromSchemaElement(const goose_parquet::SchemaElement &element,
...
ParquetColumnSchema ParquetColumnSchema::FileRowNumber() {
	...
	res.type = LogicalType::BIGINT, res.repetition_type = goose_parquet::FieldRepetitionType::type::OPTIONAL;
	return res;
}
