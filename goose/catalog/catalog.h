...
namespace goose {
    ...
    public:
        ...
        GOOSE_API optional_ptr<CatalogEntry> CreatePragmaFunction(ClientContext &context,
                                                                  CreatePragmaFunctionInfo &info);
        ...
        //! Create a pragma function in the catalog
        GOOSE_API optional_ptr<CatalogEntry>
        CreatePragmaFunction(CatalogTransaction transaction, SchemaCatalogEntry &schema,
                             CreatePragmaFunctionInfo &info);
        ...
        GOOSE_API optional_ptr<SchemaCatalogEntry> GetSchema(ClientContext &context,
                                                             const EntryLookupInfo &schema_lookup,
        ...
        GOOSE_API virtual void ScanSchemas(ClientContext &context, std::function<void(SchemaCatalogEntry &)> callback) =
        0;
        ...
        GOOSE_API CatalogEntry &GetEntry(ClientContext &context, const string &schema,
        ...
        virtual unique_ptr<LogicalOperator> BindCreateIndex(Binder &binder, CreateStatement &stmt,
    ...
    public:
        ...
        static T &GetEntry(ClientContext &context, const string &catalog_name, const string &schema_name,
            ...
            auto entry =
                    GetEntry<T>(context, catalog_name, schema_name, name, OnEntryNotFound::THROW_EXCEPTION,
                                error_context);
            return *entry;
        }
