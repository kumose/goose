...
TEST_CASE("Test using a remote optimizer pass in case thats important to someone", "[extension]") {
	...
	if (pid == 0) { // child process
		...
		REQUIRE_NO_FAIL(con1.Query("LOAD '" GOOSE_BUILD_DIRECTORY
		                           "/test/extension/loadable_extension_optimizer_demo.goose_extension'"));
